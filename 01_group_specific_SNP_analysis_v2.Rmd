...
```{r}
annotFile <- file.path("data", "all_snps_annotation.Rds")
if (file.exists(annotFile)) {
  allGroup <- readRDS(annotFile)
} else {
...
write.csv(do.call(rbind, lapply(rawResult, "[[", "dt")), file.path("data", "CDS_impact.csv"))
